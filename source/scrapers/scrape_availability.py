...
_BASE_URL = "https://pokemondb.net"
_CRAWL_DELAY = 2

_TARGET_VERSIONS = {"1": "R", "2": "C", "3": "E"}
...
class PokemonLocationScraper:
    def __init__(self):
        ...
        self.crawl_delay = _CRAWL_DELAY
        self.generation_urls = _GENERATION_URLS
        self.target_versions = _TARGET_VERSIONS
        self.results = []
        self.method_mappings = _METHOD_MAPPINGS
    ...
    def extract_location_links(self, soup: BeautifulSoup, generation: str) -> List[Tuple[str, str]]:
        ...
        region_prefixes = _REGION_PREFIXES
...
def main():
    ...
    try:
        ...
        output_path = str(paths.GEN_ALL_DIR / 'pokemon_availability_raw.csv')
