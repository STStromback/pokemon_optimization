...
# Add the source/ directory to path so the package imports below resolve
# when this module is run directly as a script.
sys.path.append(str(Path(__file__).resolve().parent.parent))

from common import paths
from common.config import get_generations, load_config
from pipeline.generate_encounters import (
    load_trainer_data,
...
def main():
    ...
    # Load configuration
    config = load_config()
    generations = get_generations(config)
