...
if all_starters:
    stats = pd.read_csv('../gen_1_data_raw/stats_gen_1.csv')
    ...
    with open('../gen_1_data_raw/wild_locations_gen_1_raw.txt', 'r') as file:
    ...
    with open('../gen_1_data_raw/wild_locations_unique_gen_1_raw.txt', 'r', encoding='utf-8') as file:
        lines = file.readlines()
    ...
    stages_df = pd.read_csv('../gen_1_data_raw/stages_gen_1.csv', usecols=['location', 'location_stage'])
    ...
    trades_df = pd.read_csv('../gen_1_data_raw/wild_locations_trades_gen_1_raw.csv')
...
df.to_csv('../gen_1_data_curated/wild_locations_gen_1.csv', index=False)
