...
def main(file_path='../gen_1_data_curated/ehl_pivot.csv', stats_file='../gen_1_data_raw/stats_gen_1.csv',
         variants_file='../gen_1_data_curated/variants_gen_1.csv', restriction_file=None):
    # Check if the output file exists and clear its contents
    final_output_file = '../gen_1_output/final_output_gen_1.txt'
...
def plot_results(logbook, suffix=""):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"../gen_1_output/fitness_over_generations{suffix}.png")
    plt.show()
...
def plot_team_value_over_party_sizes(results):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("../gen_1_output/team_value_across_party_sizes.png")
    plt.show()
...
def generate_additional_outputs(filtered_df, best_variant_ids, stats_file, variants_file, suffix=""):
    ...
    sorted_matrix_file = f'../gen_1_output/sorted_matrix1{suffix}.csv'
    ...
    # Save the heatmap
    heatmap_file = f'../gen_1_output/pokemon_encounter_heatmap{suffix}.png'
