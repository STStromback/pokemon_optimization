...
csv_file = '../gen_1_data_raw/stages_gen_1.csv'  # Path to your CSV file
...
input_file = '../gen_1_data_raw/TrainerDataGen1Raw.txt'
output_file = '../gen_1_data_curated/encounters_gen_1.csv'
stats_file = '../gen_1_data_raw/stats_gen_1.csv'
exp_table_file = '../gen_1_data_raw/exp_table.csv'
moves_file = '../gen_1_data_raw/moves_gen_1.csv'
