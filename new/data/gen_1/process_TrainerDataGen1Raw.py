...
csv_file = 'stages_gen_1.csv'  # Path to your CSV file
...
input_file = 'TrainerDataGen1Raw.txt'
output_file = 'encounters_gen_1.csv'
stats_file = 'stats_gen_1.csv'
exp_table_file = 'exp_table.csv'
moves_file = 'moves_gen_1.csv'
